...
router.post(
  "/getinvestorDataProfile",
  inverstorController.getinvestorDataProfile,
);
router.post(
  "/checkmembershipForanglenetwork",
  inverstorController.checkmembershipForanglenetwork,
);
router.post(
  "/getDiscoverCompanyList",
  inverstorController.getDiscoverCompanyList,
);
router.post("/interestedCompany", inverstorController.interestedCompany);
