...
router.post(
  ...
  dashboardController.getRoundCapTableSingleRecord,
);
router.post(
  "/getRoundCapTableAllCompanyRecord",
  dashboardController.getRoundCapTableAllCompanyRecord,
);
router.post(
  "/getRoundCapTableSingleRecordForInvestor",
  dashboardController.getRoundCapTableSingleRecordForInvestor,
);
