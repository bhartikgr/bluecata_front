"use strict";(self.webpackChunkkeiretsuproject=self.webpackChunkkeiretsuproject||[]).push([[7473],{25015:()=>{},42552:(e,s,a)=>{a.d(s,{A:()=>g});var t=a(65043),r=(a(38421),a(73216)),l=a(53579),i=a(35475),n=a(50423),o=a(42983),d=a(9463),c=a(86213),m=a(31387),x=a(47196),p=a(70579);const h=[{label:"Dashboard",href:"/user/dashboard",icon:(0,p.jsx)(x.oeo,{size:18})},{label:"Add New Company",href:"/user/addcompany",icon:(0,p.jsx)(x.S2e,{size:18})},{label:"My Companies",href:"/user/companylist",icon:(0,p.jsx)(x.S2e,{size:18})},{label:"Manage Signatory",icon:(0,p.jsx)(x.dIq,{size:18}),dropdown:[{label:"Add New Signatory",href:"/user/add-new-signatory",icon:(0,p.jsx)(x.dIq,{size:16})},{label:"Signatory List",href:"/user/signatorylist",icon:(0,p.jsx)(x._cd,{size:16})},{label:"Approve Signatories",href:"/user/approval/signature",icon:(0,p.jsx)(x.dIq,{size:16})}]},{label:"Settings",icon:(0,p.jsx)(x.XuQ,{size:18}),dropdown:[{label:"Profile Settings",href:"/user/settings/profile",icon:(0,p.jsx)(x.dIq,{size:16})}]}],u=[{path:"/crm/addnew-investor",menuHref:"/crm/investor-directory"},{path:"/crm/edit-investor/:id",menuHref:"/crm/investor-directory"},{path:"/crm/investor-report-detail-record-round/:id",menuHref:"/crm/investorreport"},{path:"/user/signatory/activity/:id/:signatory_id",menuHref:"/user/signatorylist"},{path:"/crm/investor-report-detail/:id",menuHref:"/crm/investorreport"},{path:"/crm/investor-report-detail-due-diligence/:id",menuHref:"/crm/investorreport"},{path:"/crm/investor-record-round-reports-confirm/:id",menuHref:"/crm/investorreport"},{path:"/edit-record-round/:id",menuHref:"/record-round-list"},{path:"/createrecord",menuHref:"/record-round-list"}],b=e=>{const s=u.find((s=>(0,m.B6)({path:s.path,end:!0},e)));return s?s.menuHref:e};function g(e){let{isCollapsed:s,setIsCollapsed:a}=e;const[g,v]=(0,t.useState)(""),f=(0,r.Zp)(),[j,N]=(0,t.useState)(null),[y,w]=(0,t.useState)([]),[_,S]=(0,t.useState)(!1);(0,t.useEffect)((()=>{const e=()=>{window.innerWidth<786?(S(!0),R&&R(!0)):(S(!1),R&&R(!1))};return e(),window.addEventListener("resize",e),()=>window.removeEventListener("resize",e)}),[_]);const[k,C]=(0,t.useState)(!1),D="https://blueprintcatalyst.com/backend/api/user/",A=void 0!==s?s:_,R=a||S,z=localStorage.getItem("OwnerLoginData"),I=JSON.parse(z);(0,t.useEffect)((()=>{const e=localStorage.getItem("OwnerLoginData");if(e){const s=JSON.parse(e);v(s);const a=(new Date).getTime();if(!(s.expiry&&a>s.expiry)){const e=s.expiry-a,t=setTimeout((()=>{localStorage.removeItem("OwnerLoginData"),f("/user/login")}),e);return()=>clearTimeout(t)}localStorage.removeItem("OwnerLoginData"),f("/user/login")}else f("/user/login")}),[f]),(0,t.useEffect)((()=>{L()}),[]);const L=async()=>{let e={user_id:I.id};try{0===(await c.A.post(D+"checkUserLogin",e,{headers:{Accept:"application/json","Content-Type":"application/json"}})).data.results.length&&(localStorage.removeItem("OwnerLoginData"),f("/user/login"))}catch(s){console.error("Error fetching modules:",s)}};(0,t.useEffect)((()=>{T();const e=localStorage.getItem("selectedDropdown");e&&N(Number(e));const s=localStorage.getItem("sidebarCollapsed");if(null!==s){const e=JSON.parse(s);a?a(e):S(e)}}),[]);const T=async()=>{let e={id:""};try{const s=await c.A.post(D+"getModules",e,{headers:{Accept:"application/json","Content-Type":"application/json"}});w(s.data.results)}catch(s){console.error("Error fetching modules:",s)}},O=(0,r.zy)(),E=(O.pathname,!A||k),W=b(O.pathname);return(0,p.jsxs)(p.Fragment,{children:[(0,p.jsxs)("div",{className:"main_sidenav scroll_nonw d-flex flex-column gap-5  "+(A?"collapsed p-3":"p-4"),children:[(0,p.jsxs)("div",{className:"d-flex align-items-center  gap-3 "+(A?"justify-content-center":"justify-content-between"),children:[!A&&(0,p.jsx)("a",{href:"/",className:"logo",children:(0,p.jsx)("img",{className:"w-100 h-100 object-fit-contain",src:"/logos/capavate.png",alt:"logo"})}),(0,p.jsx)(l.V4,{className:"d-flex justify-content-end",children:(0,p.jsxs)("button",{type:"button",onClick:()=>{const e=!A;R(e),localStorage.setItem("sidebarCollapsed",JSON.stringify(e))},children:[A&&(0,p.jsx)(o.A,{strokeWidth:2}),!A&&(0,p.jsx)(d.A,{strokeWidth:2})]})})]}),(0,p.jsx)(l.vT,{isOpen:E,children:(0,p.jsx)(l.c0,{children:h.map(((e,s)=>{var a;const t=j===s||e.dropdown&&e.dropdown.some((e=>{const s=b(O.pathname);return s===e.href||s.startsWith(e.href)}))||"modules"===e.dynamicDropdownKey&&y.some((e=>{const s="DATAROOM AND DUE DILIGENCE"===e.name?"/dataroom-Duediligence":`/moduleone/${e.id}`;return O.pathname===s})),r=(null===(a=e.matchPaths)||void 0===a?void 0:a.some((e=>(0,m.B6)({path:e,end:!1},O.pathname))))||O.pathname===e.href||e.dropdown&&e.dropdown.some((e=>(u[O.pathname]||O.pathname)===e.href||(u[O.pathname]||O.pathname).startsWith(e.href)))||"modules"===e.dynamicDropdownKey&&y.some((e=>{const s="DATAROOM AND DUE DILIGENCE"===e.name?"/dataroom-Duediligence":`/moduleone/${e.id}`;return O.pathname===s}));return(0,p.jsx)(l.jl,{children:e.dropdown||e.dynamicDropdownKey?(0,p.jsxs)(p.Fragment,{children:[(0,p.jsx)(l.C,{title:e.label,onClick:()=>(e=>{const s=j===e?null:e;A&&R(!A);N(s),localStorage.setItem("selectedDropdown",null!==s?s:"")})(s),children:(0,p.jsxs)("div",{className:"d-flex gap-2 align-items-center justify-content-between w-100",children:[(0,p.jsxs)("div",{className:"d-flex gap-2 align-items-start",children:[e.icon,E&&e.label]}),E&&(0,p.jsx)(l.i3,{isOpen:t,children:(0,p.jsx)(n.pte,{})})]})}),t&&(0,p.jsxs)(l.rI,{title:e.label,className:""+(E?"":"p-0"),children:[(0,p.jsx)("hr",{className:"my-2"}),e.dropdown&&e.dropdown.map(((e,s)=>{u[O.pathname]||O.pathname;const a=W===e.href||W.startsWith(e.href);return(0,p.jsx)("li",{className:"list-none",children:(0,p.jsxs)(i.N_,{to:e.href,className:`sidebar d-flex align-items-start gap-2 ${E?"":"w-fit"} ${a?"active":""}`,children:[e.icon,E&&e.label]})},s)})),"modules"===e.dynamicDropdownKey&&(0,p.jsxs)(p.Fragment,{children:[y.map(((e,s)=>{const a="DATAROOM AND DUE DILIGENCE"===e.name?"/dataroom-Duediligence":`/moduleone/${e.id}`,t=O.pathname===a;return(0,p.jsx)("li",{className:"list-none",children:(0,p.jsxs)(i.N_,{to:a,title:e.name,className:`sidebar d-flex align-items-start gap-2 ${E?"":"w-fit"} ${t?"active":""}`,children:[(0,p.jsx)(x.MO3,{size:16}),E&&e.name]})},s)})),(0,p.jsx)("li",{className:"list-none",children:(0,p.jsxs)(i.N_,{title:"VIDEO CONTENT: Investor Presentation Structure - Expert Advice Video",to:"/advicevideos",className:`sidebar d-flex align-items-start gap-2 ${E?"":"w-fit"} ${"/advicevideos"===O.pathname?"active":""}`,children:[(0,p.jsx)(x.xi0,{size:16}),E&&"VIDEO CONTENT: Investor Presentation Structure - Expert Advice Video"]})})]})]})]}):(0,p.jsxs)(i.N_,{to:e.href,title:e.label,className:`sidebar d-flex align-items-start gap-2 ${E?"":"w-fit"} ${r?"active":""}`,children:[e.icon,E&&e.label]})},s)}))})})]}),(0,p.jsx)("style",{jsx:!0,children:"\n        .main_sidenav {\n          transition: width 0.3s ease;\n        }\n\n        .main_sidenav.collapsed {\n          width: 71px;\n        }\n\n        .main_sidenav.collapsed .logo {\n          display: flex;\n          justify-content: center;\n        }\n      "})]})}},62837:(e,s,a)=>{a.d(s,{$K:()=>i,CB:()=>o,Cd:()=>v,I0:()=>c,Jq:()=>p,R3:()=>N,Zw:()=>x,dN:()=>b,hJ:()=>g,jh:()=>d,mO:()=>r,mg:()=>n,nj:()=>f,pd:()=>j,uM:()=>h,vE:()=>l,z6:()=>m});var t=a(5464);const r=t.default.div`
  input,
  textarea,
  select,
  a,
