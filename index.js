...
const Investorregister = require("./routes/user/investorregister");
//User
...
//Signatory
dotenv.config();
// ✅ Yeh add karo — server start hone se pehle
...
if (!process.env.DB_HOST) {
  console.error("FATAL ERROR: Database credentials missing in .env file");
  process.exit(1);
}
const app = express();
...
app.use("/api/user/investorregister", Investorregister);
