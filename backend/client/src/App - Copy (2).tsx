...
// Foundation Build — Partner workspace pages
  ...
  const routes = (
    ...
    <ErrorBoundary>
      <Switch>
        ...
        {/* Foundation Build — partner magic-link redemption (public; one-time token) */}
        ...
        {/* Final Partner CRM — Partner workspace routes live inside the
         * CollectiveShell at /collective/partner/*. Server API stays at
         * /api/partner/me/*; requirePartnerAuth resolves partnerId from the
         * session only. Sub-role + tier gates run at the route handler layer. */}
        ...
        {/* Backwards-compat redirects: the old /partner/me/* URLs still resolve
         * to the new /collective/partner/* paths (deep links, bookmarks). */}
        <Route path="/partner/me/dashboard">{() => <Redirect to="/collective/partner/dashboard" />}</Route>
        <Route path="/partner/me/clients/:id">{(p) => <Redirect to={`/collective/partner/clients/${(p as { id: string }).id}`} />}</Route>
        <Route path="/partner/me/clients">{() => <Redirect to="/collective/partner/clients" />}</Route>
        <Route path="/partner/me/pipeline">{() => <Redirect to="/collective/partner/pipeline" />}</Route>
        <Route path="/partner/me/team">{() => <Redirect to="/collective/partner/team" />}</Route>
        <Route path="/partner/me/notes">{() => <Redirect to="/collective/partner/notes" />}</Route>
        <Route path="/partner/me/tasks">{() => <Redirect to="/collective/partner/tasks" />}</Route>
        <Route path="/partner/me/files">{() => <Redirect to="/collective/partner/files" />}</Route>
        <Route path="/partner/me/settings">{() => <Redirect to="/collective/partner/settings" />}</Route>
        <Route path="/partner/me/spvs/:id">{(p) => <Redirect to={`/collective/partner/spvs/${(p as { id: string }).id}`} />}</Route>
        <Route path="/partner/me/spvs">{() => <Redirect to="/collective/partner/spvs" />}</Route>
        <Route path="/partner/me/funds/:id">{(p) => <Redirect to={`/collective/partner/funds/${(p as { id: string }).id}`} />}</Route>
        <Route path="/partner/me/funds">{() => <Redirect to="/collective/partner/funds" />}</Route>
