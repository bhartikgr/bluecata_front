...
export default function RoundNew() {
 ...
 <PageHeader
 title="New round"
 description="Set up a new round on NovaPay AI's cap table. Pick the round type, the investment vehicle, and the terms — we'll preview the cap-table impact before you create."
 ...
 <SelectItem value="rnd_novapay_seed">NovaPay Seed (Series Seed)</SelectItem>
 <SelectItem value="rnd_novapay_preseed">NovaPay Pre-Seed SAFE</SelectItem>
 </SelectContent>
 </Select>
