            ...
            <div className="grid lg:grid-cols-2 gap-4">
              <Card>
                ...
                <CardContent className="space-y-3">
                  <div><Label>Display name</Label><Input className="mt-1" defaultValue="Maya Chen" data-testid="input-display-name" /></div>
                  <div><Label>Email</Label><Input className="mt-1" type="email" defaultValue="maya@novapay.ai" data-testid="input-email" /></div>
                  <div><Label>Title</Label><Input className="mt-1" defaultValue="CEO & Co-founder" data-testid="input-title" /></div>
                  <div>
          ...
          <TabsContent value="company" className="mt-4">
            ...
            <Card>
              ...
              <CardContent className="grid md:grid-cols-2 gap-4">
                <div><Label>Display name</Label><Input className="mt-1" defaultValue={company?.companyName ?? "NovaPay AI"} data-testid="input-co-name" /></div>
                ...
                <div className="md:col-span-2"><Label>Tagline</Label><Input className="mt-1" defaultValue="AI-routed cross-border payments" data-testid="input-tagline" /></div>
                <div className="md:col-span-2"><Label>Description</Label><Textarea rows={3} className="mt-1" defaultValue="NovaPay AI orchestrates real-time cross-border settlements." data-testid="textarea-description" /></div>
            ...
            <Card>
              ...
              <CardContent className="p-0">
                <div className="divide-y divide-border">
                  {[
                    { id: "u_maya_chen", name: "Maya Chen", email: "maya@novapay.ai", role: "Owner", joined: "2024-01-15" },
                    { id: "u_daniel_okafor", name: "Daniel Okafor", email: "daniel@novapay.ai", role: "Admin", joined: "2024-02-01" },
                    { id: "u_sarah_kim", name: "Sarah Kim", email: "sarah@novapay.ai", role: "Member", joined: "2024-08-12" },
                  ].map(m => (
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <Card>
                ...
                <CardContent className="space-y-3">
                  ...
                  <div><Label>SSO domain</Label><Input className="mt-1" defaultValue="novapay.ai" data-testid="input-sso" /></div>
                </CardContent>
              </Card>
              <Card>
