...
export default function CRMNew() {
  ...
  const [form, setForm] = useState({ name: "", contact: "", email: "", stage: "", checkSize: "", notes: "" });
        ...
        <Card>
          ...
          <CardContent className="space-y-4 max-w-2xl">
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div><Label>Stage focus</Label><Input className="mt-1" value={form.stage} onChange={e => update("stage", e.target.value)} placeholder="Seed–Series A" data-testid="input-stage" /></div>
