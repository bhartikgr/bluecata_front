...
// Demo personas — only rendered when ?demo=1 is present in the URL.
// In production builds these are still present in the bundle but never shown
// unless the operator/QA explicitly opens the demo URL.
