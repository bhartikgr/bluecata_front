...
interface DealRoomCompany {
  ...
  dscTier: string | null;
  tagline: string | null;
  // Final Partner CRM: attribution when entry was promoted by a Consortium Partner
  source?: "collective" | "partner" | null;
    ...
    <div className="p-6 max-w-7xl mx-auto space-y-5">
      ...
      <Card>
        <CardContent className="p-0">
          {error && (
            isCollectiveMembershipError(error) ? <CollectiveMembershipNotice /> : <div className="p-6 text-sm text-red-600" data-testid="error-dealroom">
                      ...
                      <div>
                        <div className="flex items-center gap-2">
                          ...
                          {company.source === "partner" && (
                            ...
                            >
                              via {company.sourcePartnerName ?? "Partner"}
                            </Badge>
                          )}
                        </div>
                        {company.tagline && (
