...
export default function InvestorCRM() {
  ...
  // Sprint 23 hotfix: graceful fallback when /api/investor/crm 404s on a static
  // deploy. We render the same seed list the server would return (one contact
  // per stage so the filter chips have content). Production builds with a
  // backend get the real list — the catch-fallback only fires on 404/network.
  const DEMO_CRM_FALLBACK: InvestorCrmContact[] = [
    { id: "icrm_d1", investorId: "u_aisha_patel", name: "James Okafor", title: "Partner", email: "james@hydracapital.com", affiliation: "Hydra Capital", stage: "cold", tags: ["vc", "lead-investor"], starred: false, notes: [], tasks: [], createdAt: "2026-04-01T10:00:00Z", updatedAt: "2026-04-01T10:00:00Z" } as unknown as InvestorCrmContact,
    { id: "icrm_d2", investorId: "u_aisha_patel", name: "Priya Raghunathan", title: "GP", email: "priya@bluepoint.vc", affiliation: "Bluepoint Angels", stage: "met", tags: ["angel", "healthtech"], starred: false, notes: [], tasks: [], createdAt: "2026-04-03T10:00:00Z", updatedAt: "2026-04-03T10:00:00Z" } as unknown as InvestorCrmContact,
    { id: "icrm_d3", investorId: "u_aisha_patel", name: "Marcus Webb", title: "Partner", email: "marcus@forgevc.com", affiliation: "Forge Ventures", stage: "discussing", tags: ["b2b", "saas"], starred: true, notes: [], tasks: [], createdAt: "2026-04-05T10:00:00Z", updatedAt: "2026-04-05T10:00:00Z" } as unknown as InvestorCrmContact,
    { id: "icrm_d4", investorId: "u_aisha_patel", name: "Yuki Tanaka", title: "Managing Director", email: "yuki@arboreal.io", affiliation: "Arboreal Capital", stage: "following", tags: ["climate", "deeptech"], starred: false, notes: [], tasks: [], createdAt: "2026-04-07T10:00:00Z", updatedAt: "2026-04-07T10:00:00Z" } as unknown as InvestorCrmContact,
    { id: "icrm_d5", investorId: "u_aisha_patel", name: "Elena Vasquez", title: "CEO", email: "elena@quanta.ai", affiliation: "Quanta AI", stage: "backed", tags: ["ai", "infra"], starred: true, platformUserId: "u_forge_ventures", notes: [], tasks: [], createdAt: "2026-04-09T10:00:00Z", updatedAt: "2026-04-09T10:00:00Z" } as unknown as InvestorCrmContact,
    { id: "icrm_d6", investorId: "u_aisha_patel", name: "David Kim", title: "CTO", email: "david@tideline.io", affiliation: "Tideline Systems", stage: "co_invested", tags: ["maritime", "iot"], starred: false, notes: [], tasks: [], createdAt: "2026-04-11T10:00:00Z", updatedAt: "2026-04-11T10:00:00Z" } as unknown as InvestorCrmContact,
    { id: "icrm_d7", investorId: "u_aisha_patel", name: "Amara Nwosu", title: "Founder", email: "amara@beacon.io", affiliation: "Beacon Health", stage: "closed_no", tags: ["healthtech"], starred: false, notes: [], tasks: [], createdAt: "2026-04-13T10:00:00Z", updatedAt: "2026-04-13T10:00:00Z" } as unknown as InvestorCrmContact,
    { id: "icrm_d8", investorId: "u_aisha_patel", name: "Lena Schmidt", title: "CFO", email: "lena@coldstar.co", affiliation: "ColdStar Capital", stage: "cold", tags: ["growth"], starred: true, notes: [], tasks: [], createdAt: "2026-04-15T10:00:00Z", updatedAt: "2026-04-15T10:00:00Z" } as unknown as InvestorCrmContact,
  ];
  const listQ = useQuery<InvestorCrmContact[]>({
    ...
    queryFn: async () => {
      try {
        ...
        return Array.isArray(data) && data.length > 0 ? data : DEMO_CRM_FALLBACK;
      } catch {
        return DEMO_CRM_FALLBACK;
      }
    },
  });
