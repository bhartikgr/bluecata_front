 ...
 *  - Cap-Table channel shows company name (e.g. "NovaPay AI — Cap Table") — from seed data ✓
 *  - Soft-Circle channel shows round name (e.g. "NovaPay Seed Extension — Soft-Circle") ✓
