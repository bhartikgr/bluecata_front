...
const files: DRFile[] = [
  { id: "drf_pitch_q2",    companyId: "co_novapay", folderId: "fld_pitch",      name: "NovaPay Pitch Q2 2026.pdf",  sizeBytes: 4_200_000, mime: "application/pdf", uploadedAt: "2026-04-15T14:00:00Z", uploadedBy: "Maya Chen", sha256: "demo-pitch-pdf", watermark: true },
  { id: "drf_revops",      companyId: "co_novapay", folderId: "fld_financials", name: "RevOps Snapshot Apr.xlsx",   sizeBytes: 920_000,   mime: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", uploadedAt: "2026-04-29T11:00:00Z", uploadedBy: "CFO", sha256: "demo-revops", watermark: false },
  { id: "drf_articles",    companyId: "co_novapay", folderId: "fld_legal",      name: "Articles of Incorporation.pdf", sizeBytes: 285_000, mime: "application/pdf", uploadedAt: "2024-04-01T09:00:00Z", uploadedBy: "Counsel", sha256: "demo-articles", watermark: true },
  { id: "drf_dd_master",   companyId: "co_novapay", folderId: "fld_diligence",  name: "DD Master Index.xlsx",       sizeBytes: 110_000,   mime: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", uploadedAt: "2026-05-01T09:00:00Z", uploadedBy: "Maya Chen", sha256: "demo-dd-idx", watermark: false },
  { id: "drf_seed_terms",  companyId: "co_novapay", folderId: "fld_round_seed", name: "Seed Extension Term Sheet v3.pdf", sizeBytes: 320_000, mime: "application/pdf", uploadedAt: "2026-05-04T14:00:00Z", uploadedBy: "Maya Chen", sha256: "demo-seed-terms", watermark: true },
];
...
const events: DREvent[] = [
  { id: "drev_1", companyId: "co_novapay", ts: "2026-05-08T10:13:00Z", actor: "u_aisha_patel", action: "view",     targetKind: "file", targetId: "drf_pitch_q2",   meta: { duration_s: 142 } },
  { id: "drev_2", companyId: "co_novapay", ts: "2026-05-07T11:42:00Z", actor: "u_aisha_patel", action: "download", targetKind: "file", targetId: "drf_pitch_q2",   meta: { ip: "—" } },
  { id: "drev_3", companyId: "co_novapay", ts: "2026-05-06T09:00:00Z", actor: "Maya Chen",     action: "upload",   targetKind: "file", targetId: "drf_seed_terms", meta: { folderId: "fld_round_seed" } },
  { id: "drev_4", companyId: "co_novapay", ts: "2026-05-05T16:00:00Z", actor: "Maya Chen",     action: "permission_change", targetKind: "permission", targetId: "u_aisha_patel:fld_round_seed", meta: { view: true, download: true } },
];
...
export function registerDataroomRoutes(app: Express): void {
  ...
  app.post("/api/founder/dataroom/folders", (req, res) => {
    ...
    folders.push(f);
    logEvent({ companyId: f.companyId, actor: "Maya Chen", action: "folder_create", targetKind: "folder", targetId: f.id, meta: { name } });
    res.json(f);
  });
  ...
  app.post("/api/founder/dataroom/files", upload.single("file"), (req, res) => {
    ...
    const folderId = String(req.body?.folderId ?? folders[0].id);
    const companyId = String(req.body?.companyId ?? "co_novapay");
    ...
    files.push(f);
    logEvent({ companyId, actor: "Maya Chen", action: "upload", targetKind: "file", targetId: f.id, meta: { name: f.name, sizeBytes: f.sizeBytes } });
  ...
  app.get("/api/founder/dataroom/files/:id/download", (req, res) => {
    ...
    logEvent({ companyId: f.companyId, actor: investorId ?? "Maya Chen", action: "download", targetKind: "file", targetId: f.id });
    if (!f._buf) {
  ...
  app.post("/api/founder/dataroom/permissions", (req, res) => {
    ...
    logEvent({ companyId: "co_novapay", actor: "Maya Chen", action: "permission_change", targetKind: "permission", targetId: `${investorId}:${folderId}`, meta: { view: p.view, download: p.download } });
    res.json(p);
  });
