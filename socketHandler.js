...
module.exports = (io) => {
  ...
  // =========================================================================
  // NEW Helper — social:pin_update
  // =========================================================================
  io.emitPinUpdate = (user_id, payload) => {
    io.to(`social_user_${user_id}`).emit("social:pin_update", payload);
    console.log(
      `📌 pin_update → social_user_${user_id}, post=${payload.post_id}, is_pinned=${payload.is_pinned}`,
    );
  };
};
