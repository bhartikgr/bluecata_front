      ...
      <table style="width:100%; border-collapse: collapse;">
        <tr>
          <td style="background:#efefef; padding:10px; text-align:center;">
            <img src="https://blueprintcatalyst.com/backend/api/upload/images/logo.png" alt="logo" style="width:130px;" />
          </td>
        </tr>
        <tr>
  ...
  try {
    ...
    for (const [templateType, { hours, dbField }] of Object.entries(
      ...
      for (const meeting of meetings) {
        ...
        if (diffMinutes <= 10) {
          const zoomLink =
            "https://blueprintcatalyst.com/backend/api/zoommeeting?token=" +
            meeting.unique_code;
...
https://blueprintcatalyst.com/backend/register?ref=${discount_code}
...
Log in here: https://blueprintcatalyst.com/backend/login
