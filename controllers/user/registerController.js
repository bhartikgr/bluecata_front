      ...
      <table style="width:100%; border-collapse: collapse;">
        <tr>
          <td style="background:#efefef; padding:10px; text-align:center;">
            <img src="http://blueprintcatalyst.com/api/upload/images/logo.png" alt="logo" style="width:130px;" />
          </td>
        </tr>
        <tr>
    ...
    <body style="background: #f9fafb; padding: 20px; font-family: Verdana, Geneva, sans-serif;">
      <div style="width: 600px; margin: 0 auto; border: 1px solid #e5e7eb; border-radius: 10px; overflow: hidden; background: #fff;">
        <table style="width: 100%; border-collapse: collapse;">
          <tr>
            <td style="background: #efefef; padding: 10px 0; text-align: center;">
              <img src="http://blueprintcatalyst.com/api/upload/images/logo.png" alt="Capavate Logo" style="width: 130px;" />
            </td>
          </tr>
          <tr>
            <td style="padding: 20px; color: #111; font-size: 14px;">
              ...
              <div style="text-align: center; margin: 20px 0;">
                <a href="http://blueprintcatalyst.com/user/login" style="background:#ff3c3e; color:#fff; text-decoration:none; font-size:14px; padding:10px 30px; border-radius:10px;">Login Now</a>
              </div>
              <p style="margin: 30px 0 10px 0; font-size: 14px; text-align: center; color: #555;">
                Capavate Powered by <b>Blueprint Catalyst Ltd</b>
              </p>
...
function sendEmailResendActivateLink(to, fullName, activationCode) {
  ...
  const activationUrl = `http://blueprintcatalyst.com/activate-account?code=${activationCode}&email=${encodeURIComponent(
    to
  )}`;
  ...
  try {
    ...
    for (const [templateType, { hours, dbField }] of Object.entries(
      ...
      for (const meeting of meetings) {
        ...
        if (diffMinutes <= 10) {
          const zoomLink =
            "http://blueprintcatalyst.com/api/zoommeeting?token=" +
            meeting.unique_code;
...
exports.sendcontactInfo = async (req, res) => {
  try {
    ...
    await sendContactEmail({
      to: "avinayquicktech@gmail.com", // Your internal email to receive the message
      fullName,
      phone: data.phone,
      email: data.email,
...
function sendContactEmail({
  ...
  const htmlContent = `
    <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
      ...
      <p><strong>Submitted on:</strong> ${dateFormatted}</p>
      <hr/>
      <p style="margin-top: 20px;">This message was received from the website contact form.</p>
    </div>
  `;
...
http://blueprintcatalyst.com/register?ref=${discount_code}
...
Log in here: http://blueprintcatalyst.com/login
                ...
                signatories.forEach((s) => {
                  ...
                  db.query(
                    ...
                    (signErr) => {
                      ...
                      insertedCount++;
                      const inviteLink = `http://blueprintcatalyst.com/signatory/accept/${uniqueCode}`;
      ...
      <table style="width:100%; border-collapse: collapse;">
        ...
        <tr>
          <td style="padding:25px;">
            ...
            <p style="font-size:14px; color:#111; margin-bottom:15px;">
              <a href="http://blueprintcatalyst.com/user/dashboard" style=" background: #ff3c3e;
        ...
        <table style="width:100%;border-collapse:collapse;">
          ...
          <tr>
            <td style="padding:25px;">
              ...
              <p style="font-size:14px;color:#111;margin-bottom:15px;">
                <a href="http://blueprintcatalyst.com/authorized-signature" style="background:#ff3c3e;color:#fff;padding:10px 20px;text-decoration:none;border-radius:5px;font-weight:bold;">Click Here</a>
              </p>
              <p style="font-size:14px;color:#111;margin-bottom:0;">Regards,<br/>Capavate Team</p>
            </td>
          </tr>
      ...
      <table style="width:100%; border-collapse: collapse;">
        ...
        <tr>
          <td style="padding:25px;">
            ...
            <p style="font-size:14px; color:#111; margin-bottom:15px;">
              <a href="http://blueprintcatalyst.com/authorized-signature" style="background:#ff3c3e; color:#fff; padding:10px 20px; text-decoration:none; border-radius:5px; font-weight:bold;">
                Click Here
              </a>
            </p>
            <p style="font-size:14px; color:#111; margin-bottom:0;">Regards,<br/>Capavate Team</p>
