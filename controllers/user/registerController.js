          ...
          <tr>
            <td style="padding: 20px; color: #111; font-size: 14px;">
              ...
              <div style="text-align: center; margin: 20px 0;">
                <a
                  href="https://blueprintcatalyst.com/user/login"
                  style="
                    background: #ff3c3e;
                    color: #fff;
        ...
        <table style="width: 100%; border-collapse: collapse;">
          ...
          <tr>
            <td style="padding: 20px; color: #111; font-size: 14px;">
              ...
              <div style="text-align: center; margin: 20px 0;">
                <a href="https://blueprintcatalyst.com/user/login" style="background:#ff3c3e; color:#fff; text-decoration:none; font-size:14px; padding:10px 30px; border-radius:10px;">Login Now</a>
              </div>
              <p style="margin: 30px 0 10px 0; font-size: 14px; text-align: center; color: #555;">
                Capavate Powered by <b>Blueprint Catalyst Ltd</b>
              </p>
      ...
      <table style="width:100%; border-collapse: collapse;">
        ...
        <tr>
          <td style="padding:25px;">
            ...
            <p style="font-size:14px; color:#111; margin-bottom:15px;">
              <a href="https://blueprintcatalyst.com/user/dashboard" style=" background: #ff3c3e;
        ...
        <table style="width:100%;border-collapse:collapse;">
          ...
          <tr>
            <td style="padding:25px;">
              ...
              <p style="font-size:14px;color:#111;margin-bottom:15px;">
                <a href="https://blueprintcatalyst.com/authorized-signature" style="background:#ff3c3e;color:#fff;padding:10px 20px;text-decoration:none;border-radius:5px;font-weight:bold;">Click Here</a>
              </p>
              <p style="font-size:14px;color:#111;margin-bottom:0;">Regards,<br/>Capavate Team</p>
            </td>
          </tr>
      ...
      <table style="width:100%; border-collapse: collapse;">
        ...
        <tr>
          <td style="padding:25px;">
            ...
            <p style="font-size:14px; color:#111; margin-bottom:15px;">
              <a href="https://blueprintcatalyst.com/authorized-signature" style="background:#ff3c3e; color:#fff; padding:10px 20px; text-decoration:none; border-radius:5px; font-weight:bold;">
                Click Here
              </a>
            </p>
            <p style="font-size:14px; color:#111; margin-bottom:0;">Regards,<br/>Capavate Team</p>
