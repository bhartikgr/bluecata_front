                ...
                db.query(
                  ...
                  async (err, fileSummaryResults) => {
                    ...
                    if (fileSummaryResults[0].company_logo !== null) {
                      ...
                      var fullPath = `https://blueprintcatalyst.com/backend/api/${pathname}/${fileSummaryResults[0].company_logo}`;
      ...
      const updatedResults = row.map((doc) => ({
        ...
        downloadUrl:
          doc.company_logo && doc.company_logo.trim() !== ""
            ? `https://blueprintcatalyst.com/backend/api/${pathname}/${doc.company_logo}`
            : "https://blueprintcatalyst.com/backend/api/upload/docs/download.png",
      }));
