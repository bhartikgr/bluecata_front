                      ...
                      async (err, companyLogos) => {
                        ...
                        if (companyLogos && companyLogos.length > 0) {
                          companyLogoPaths = companyLogos.map((logo) => {
                            ...
                            const fullPath = `https://blueprintcatalyst.com/api/${pathname}/${logo.doc_name}`;
                            //const fullPath =
                            //"https://blueprintcatalyst.com/static/media/capavate.b15264e93ae9765cfd05.png";
                          ...
                          const pathname = `upload/docs/doc_${responses.company_id}/${logo.folder_name}`;
                          const fullPath = `https://blueprintcatalyst.com/api/${pathname}/${fileSummaryResults[0].company_logo}`;
                          // const fullPath =
                          //   "https://blueprintcatalyst.com/static/media/capavate.b15264e93ae9765cfd05.png";
    ...
    db.query(
      ...
      (err, subscriptionResults) => {
        ...
        if (subscriptionResults.length === 0) {
          return res
            .status(200)
            .json({ message: "No subscription found", type: 2 });
        }
