...
exports.signatorylogin = (req, res) => {
  ...
  db.query(
    ...
    async (err, results) => {
      ...
      const token = jwt.sign(
        { email: signatory.signatory_email, role: "signatory" },
        "SECRET_KEY",
        { expiresIn: "1h" }
      );
      ...
      res.status(200).json({
        ...
        user: {
          ...
          companies: [
            {
              id: signatory.company_id,
              name: signatory.company_name,
            },
          ],
        },
      });
