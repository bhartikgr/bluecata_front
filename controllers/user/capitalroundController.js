...
async function handleCommonStockCalculation(params, updateFlag = false) {
  ...
  console.log(newInvestorSharesBeforeOption, "newInvestorSharesBeforeOption");
...
async function calculateWarrantFromInvestorData(
  ...
  if (warrant.warrantType === "percentage") {
    ...
    if (discountPercentage === 0) {
      potentialShares = share_price * coverageDecimal; // 3,267.97
    } else {
...
async function calculateWarrantSharesForOptionPool(
  ...
  console.log("=== calculateWarrantSharesForOptionPool Debug ===");
  console.log("Investment Amount:", investmentAmount);
  console.log("Share Price Value:", sharePriceValue);
  console.log("Coverage Percentage:", coveragePercentage);
  console.log("Warrant Type:", warrant.warrantType);
  ...
  if (warrant.warrantType === "percentage") {
    ...
    if (discountPercentage === 0) {
      ...
      warrantShares = totalSharesAtDiscountedPrices * coverageDecimal;
    } else {
