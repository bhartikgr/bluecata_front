...
async function handleCommonStockCalculation(params, updateFlag = false) {
  ...
  if (previousRounds.length > 0 && latestPreviousRound) {
    ...
    existingOptionPoolShares =
      ...
      0;
    totalPreMoneyShares = parseFloat(round.total_shares_after) || round0Shares;
  ...
  if (hasInvestmentRoundBefore && previousRounds.length > 0) {
    ...
    preMoneyTotalSharesCalc =
      round0Shares + optionPoolShares + totalConvertedShares;
    console.log(round0Shares, "round0Shares");
    console.log(optionPoolShares, "optionPoolShares");
    console.log(totalConvertedShares, "totalConvertedShares");
    const investorPostMoneyOwnership =
      (roundSizeVal / postMoneyValuation) * 100;
    console.log(investorPostMoneyOwnership, "investorPostMoneyOwnership");
    console.log(roundSizeVal, "roundSizeVal");
    console.log(postMoneyValuation, "postMoneyValuations");
    totalPostShares =
      preMoneyTotalSharesCalc / (1 - investorPostMoneyOwnership / 100);
    newInvestorShares = totalPostShares - preMoneyTotalSharesCalc;
    updatedSharePrice = roundSizeVal / newInvestorShares;
  ...
  console.log(postMoneyValuation, "postMoneyValuation");
...
async function handlePreferredEquityCalculation(params, updateFlag = false) {
  ...
  if (hasInvestmentRoundBefore && previousRounds.length > 0) {
    ...
    console.log("newInvestorSharesFixed:", newInvestorSharesFixed); // 37,037 ✅
    console.log(totalPostShares, "totalPostShares");
    ...
    totalWarrantShares = totalWarrantSharesTemp;
    console.log("totalWarrantShares:", totalWarrantShares); // 7,407 ✅
    ...
    preMoneyTotalSharesCalc =
      ...
      totalWarrantShares;
    console.log("preMoneyTotalSharesCalc:", preMoneyTotalSharesCalc); // 118,518
    ...
    if (postMoneyPoolTarget > preMoneyPoolPercent) {
      ...
      console.log("sharesBeforeOptionTopUp:", sharesBeforeOptionTopUp);
      console.log("totalSharesAfterOptionTopUp:", totalSharesAfterOptionTopUp);
      console.log("newOptionShares:", newOptionShares);
      console.log("newInvestorShares (UNCHANGED):", newInvestorShares);
      console.log("totalPostShares:", totalPostShares);
      console.log("updatedSharePrice (UNCHANGED):", updatedSharePrice);
      console.log("postMoneyValuation:", postMoneyValuation);
    } else {
...
async function calculateWarrantSharesForOptionPool(
  ...
  if (warrant.warrantType === "percentage") {
    ...
    warrantShares = sharess * coverageDecimal;
    console.log(warrantShares, "warrantShares");
    // ✅ Step 3: Warrant Value = (Warrant Shares / Total Post Shares) × Post Money Valuation
    // Using the same formula as other investors
    const ownership = warrantShares / totalpostshare;
    const rawPercentage = ownership * 100;
