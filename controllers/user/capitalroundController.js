      ...
      db.query(
        ...
        async (err, results) => {
          ...
          db.query(sql, values, async (err) => {
            ...
            console.log(hasWarrants_preferred);
            console.log(typeof hasWarrants_preferred);
            if (hasWarrants_preferred === "true") {
              console.log(typeof hasWarrants_preferred);
              const warrantdata = {
                warrant_coverage_percentage:
...
const createWarrantDataInternal = (warrantData) => {
  return new Promise((resolve, reject) => {
    ...
    console.log("Formatted expiration_date:", formattedExpirationDate);
  ...
  db.query(checkRoundZeroQuery, [company_id], (err, roundZeroResult) => {
    ...
    if (roundZeroResult.length > 0) {
      ...
      db.query(query, [company_id], (err, results) => {
        ...
        console.log(results); // Now results is defined here
        res.status(200).json({
          success: true,
          message: "",
