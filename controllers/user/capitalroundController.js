...
exports.getRoundwarrant = (req, res) => {
  ...
  warrant_conversion_share_record.main_shares,
  warrant_conversion_share_record.warrant_share
FROM round_investors
LEFT JOIN warrants ON warrants.id = round_investors.warrant_id
LEFT JOIN warrant_conversion_share_record ON warrant_conversion_share_record.warrant_id = warrants.id 
  AND warrant_conversion_share_record.company_id = ?
