...
exports.proposalAgentfilter = async (req, res) => {
  var data = req.body;
  const query = `SELECT *  FROM proposal_agents WHERE invite_token = ? And status =? order by id desc`;
...
exports.proposalAgentassistant = async (req, res) => {
  var data = req.body;
  const query = `SELECT *  FROM proposal_agents WHERE agent_user_id = ? And status =? order by id desc`;
...
exports.getMarketplaceProposal = async (req, res) => {
  var data = req.body;
  const query = `SELECT *  FROM marketplaceproposal WHERE id = ? order id desc`;
...
exports.getSponsorshipProposal = async (req, res) => {
  var data = req.body;
  const query = `SELECT *  FROM sponsorshipproposal_export WHERE id = ? order by id desc`;
    ...
    html: `
      <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
        ...
        <p style="margin-top: 20px;">
          <a href="https://communitysponsoradmin.com/agenthub" 
